...
$fusion_shortcodes['fullwidth'] = array(
	...
	'params' => array(
		...
		'background_parallax' => array(
			...
			'std' => 'none',
			'options' => array(
				'none'  => __( 'No Parallax', 'fusion-core' ),
				'fixed' => __( 'Fixed', 'fusion-core' ),
				'up'    => __( 'Up', 'fusion-core' ),
				'down'  => __( 'Down', 'fusion-core' ),
				'left'  => __( 'Left', 'fusion-core' ),
		...
		'parallax_speed' => array(
			...
			'desc' => __( 'The movement speed, value should be between 0.1 and 1.0. A lower number means slower scrolling speed.', 'fusion-core' ),
			'std' => '0.3',
		),
		'enable_mobile' => array(
			'type' => 'select',
...
$fusion_shortcodes['taglinebox'] = array(
	...
	'params' => array(
		...
		'margin_bottom' => array(
			'std' => '',
			'type' => 'text',
			'label' => __( 'Bottom Top', 'fusion-core' ),
