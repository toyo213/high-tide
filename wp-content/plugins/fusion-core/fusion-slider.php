	...
	class Fusion_Slider {
		...
		function slider_add_new_meta_fields() {
			...
			<div class="form-field">
				...
				<p class="description"><?php _e( 'IMPORTANT: you must have "Responsive Type" option enabled in theme options > typography for this to work.  Minimum font factor is used to determine minimum distance between headings and body type by a multiplying value. ex: 1.5', 'fusion-core' ); ?></p>
			</div>
		<?php
		}
